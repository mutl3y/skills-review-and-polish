---
name: documentation-review-v4
description: Verify repository documentation using repository evidence. Produce the minimum set of modifications required to satisfy the verification criteria. Glossary-first: every term used by a constraint or rule is defined before use.
---
...
A Modification is forbidden if it is a Stylistic Rewrite.

A Modification is permitted if it is a Factual Fix, a Clarification, or a Deletion, AND it satisfies C1, C2, C3, C5, and R1.
...
- Apply a permitted Modification (D8) to the affected statement only.
...
Apply a permitted Modification (D8) to the statements that satisfy R1.
...
- [ ] Every Modification (D8) satisfies R1.
