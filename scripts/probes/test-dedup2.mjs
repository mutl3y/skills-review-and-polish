...
const f2 = {code:'hygiene-redundant-instruction',message:'',severity:'warning',range:{start:{line:5,character:0},end:{line:5,character:20}},analyzer:'hygiene-check',relevantText:''};
