<!-- faf:start -->
# CLAUDE.md — skills-review-and-polish
...
- **Build:** TypeScript + esbuild/tsc
- **Api Type:** VS Code extension API + MCP (stdio)
- **Backend:** VS Code extension (no server)
- **Frontend:** VS Code UI (webview/diagnostics)
- **Hosting:** VS Code marketplace
- **Css Framework:** N/A (VS Code extension)
- **Ui Library:** N/A (VS Code native UI)
- **State Management:** N/A (extension state)
- **Database:** N/A (no database)
- **Connection:** N/A (no external DB)
...
- **When:** Active dev, v0.1.50
- **How:** 6-wave LLM analyzer + surgical fixer

---

*STATUS: BI-SYNC ACTIVE — 2026-08-08T19:44:26.167Z*
<!-- faf:end -->
...
*Last Sync: 2026-08-08T19:40:50.579Z*
