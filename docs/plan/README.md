...
## Documents (4 core files)

| Document | Purpose | Audience |
| --- | --- | --- |
| [RELEASE-IMPLEMENTATION-PLAN.md](RELEASE-IMPLEMENTATION-PLAN.md) | 5-phase release gate verification + formal release status | Release leads, anyone publishing |
...
**Just shipped?** Start with [RELEASE-IMPLEMENTATION-PLAN.md](RELEASE-IMPLEMENTATION-PLAN.md) — all 5 verification phases documented.
